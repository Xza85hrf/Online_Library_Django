...
class Command(BaseCommand):
    help = 'Generate missing images for books, authors, and publishers using Flux AI'
    ...
    def handle(self, *args, **options):
        ...
        if image_type in ['books', 'all']:
            self.generate_book_covers(batch_size, pause_seconds, limit, fallback)
        
        if image_type in ['authors', 'all']:
            self.generate_author_photos(batch_size, pause_seconds, limit, fallback)
        
        if image_type in ['publishers', 'all']:
            self.generate_publisher_logos(batch_size, pause_seconds, limit, fallback)
    
    def generate_book_covers(self, batch_size, pause_seconds, limit, fallback):
    ...
    def generate_author_photos(self, batch_size, pause_seconds, limit, fallback):
    ...
    def generate_publisher_logos(self, batch_size, pause_seconds, limit, fallback):
